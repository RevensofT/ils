...
#Region ".field"
        ...
        Public Function field(Of T1, T As Class)(Host As ils(Of T), Name1 As String) As ils(Of T)
            Host.fields = {Info.type(Of T1).field(Name1)}
            Return Host
        End Function

        <Extension, Method(inline)>
        Public Function field(Of T2, T1, T As Class)(Host As ils(Of T), Name2 As String, Name1 As String) As ils(Of T)
            Host.fields = {Info.type(Of T2).field(Name2), Info.type(Of T1).field(Name1)}
            Return Host
        End Function
        ...
        Public Function field(Of T3, T2, T1, T As Class)(Host As ils(Of T), Name3 As String, Name2 As String, Name1 As String) As ils(Of T)
            Host.fields = {Info.type(Of T3).field(Name3), Info.type(Of T2).field(Name2), Info.type(Of T1).field(Name1)}
            Return Host
        End Function
        ...
        Public Function field(Of T4, T3, T2, T1, T As Class)(Host As ils(Of T), Name4 As String, Name3 As String, Name2 As String, Name1 As String) As ils(Of T)
            Host.fields = {Info.type(Of T4).field(Name4), Info.type(Of T3).field(Name3), Info.type(Of T2).field(Name2), Info.type(Of T1).field(Name1)}
            Return Host
        End Function
        ...
        Public Function field(Of T5, T4, T3, T2, T1, T As Class)(Host As ils(Of T), Name5 As String, Name4 As String, Name3 As String, Name2 As String, Name1 As String) As ils(Of T)
            Host.fields = {Info.type(Of T5).field(Name5), Info.type(Of T4).field(Name4), Info.type(Of T3).field(Name3), Info.type(Of T2).field(Name2), Info.type(Of T1).field(Name1)}
            Return Host
        End Function
        ...
        Public Function field(Of T6, T5, T4, T3, T2, T1, T As Class)(Host As ils(Of T), Name6 As String, Name5 As String, Name4 As String, Name3 As String, Name2 As String, Name1 As String) As ils(Of T)
            Host.fields = {Info.type(Of T6).field(Name6), Info.type(Of T5).field(Name5), Info.type(Of T4).field(Name4), Info.type(Of T3).field(Name3), Info.type(Of T2).field(Name2), Info.type(Of T1).field(Name1)}
            Return Host
        End Function
        ...
        Public Function field(Of T7, T6, T5, T4, T3, T2, T1, T As Class)(Host As ils(Of T), Name7 As String, Name6 As String, Name5 As String, Name4 As String, Name3 As String, Name2 As String, Name1 As String) As ils(Of T)
            Host.fields = {Info.type(Of T7).field(Name7), Info.type(Of T6).field(Name6), Info.type(Of T5).field(Name5), Info.type(Of T4).field(Name4), Info.type(Of T3).field(Name3), Info.type(Of T2).field(Name2), Info.type(Of T1).field(Name1)}
            Return Host
        End Function
        ...
        Public Function field(Of T8, T7, T6, T5, T4, T3, T2, T1, T As Class)(Host As ils(Of T), Name8 As String, Name7 As String, Name6 As String, Name5 As String, Name4 As String, Name3 As String, Name2 As String, Name1 As String) As ils(Of T)
            Host.fields = {Info.type(Of T8).field(Name8), Info.type(Of T7).field(Name7), Info.type(Of T6).field(Name6), Info.type(Of T5).field(Name5), Info.type(Of T4).field(Name4), Info.type(Of T3).field(Name3), Info.type(Of T2).field(Name2), Info.type(Of T1).field(Name1)}
            Return Host
        End Function
#End Region
...
#Region "delegates"
        ...
        Public Function used(Of T1 As Class, T As Class)(Host As ils(Of T)) As ils(Of T)
            Host.useds = {Info.delegate(Of T1).invoker}
            Return Host
        End Function
        <Extension, Method(inline)>
        Public Function used(Of T1 As Class, T2 As Class, T As Class)(Host As ils(Of T)) As ils(Of T)
            Host.useds = {Info.delegate(Of T1).invoker, Info.delegate(Of T2).invoker}
            Return Host
        End Function

        <Extension, Method(inline)>
        Public Function used(Of T3 As Class, T2 As Class, T1 As Class, T As Class)(Host As ils(Of T)) As ils(Of T)
            Host.useds = {Info.delegate(Of T3).invoker, Info.delegate(Of T2).invoker, Info.delegate(Of T1).invoker}
            Return Host
        End Function

        <Extension, Method(inline)>
        Public Function used(Of T4 As Class, T3 As Class, T2 As Class, T1 As Class, T As Class)(Host As ils(Of T)) As ils(Of T)
            Host.useds = {Info.delegate(Of T4).invoker, Info.delegate(Of T3).invoker, Info.delegate(Of T2).invoker, Info.delegate(Of T1).invoker}
            Return Host
        End Function
        ...
        Public Function used(Of T5 As Class, T4 As Class, T3 As Class, T2 As Class, T1 As Class, T As Class)(Host As ils(Of T)) As ils(Of T)
            Host.useds = {Info.delegate(Of T5).invoker, Info.delegate(Of T4).invoker, Info.delegate(Of T3).invoker, Info.delegate(Of T2).invoker, Info.delegate(Of T1).invoker}
            Return Host
        End Function
        ...
        Public Function used(Of T6 As Class, T5 As Class, T4 As Class, T3 As Class, T2 As Class, T1 As Class, T As Class)(Host As ils(Of T)) As ils(Of T)
            Host.useds = {Info.delegate(Of T6).invoker, Info.delegate(Of T5).invoker, Info.delegate(Of T4).invoker, Info.delegate(Of T3).invoker, Info.delegate(Of T2).invoker, Info.delegate(Of T1).invoker}
            Return Host
        End Function
        ...
        Public Function used(Of T7 As Class, T6 As Class, T5 As Class, T4 As Class, T3 As Class, T2 As Class, T1 As Class, T As Class)(Host As ils(Of T)) As ils(Of T)
            Host.useds = {Info.delegate(Of T7).invoker, Info.delegate(Of T6).invoker, Info.delegate(Of T5).invoker, Info.delegate(Of T4).invoker, Info.delegate(Of T3).invoker, Info.delegate(Of T2).invoker, Info.delegate(Of T1).invoker}
            Return Host
        End Function
        ...
        Public Function used(Of T8 As Class, T7 As Class, T6 As Class, T5 As Class, T4 As Class, T3 As Class, T2 As Class, T1 As Class, T As Class)(Host As ils(Of T)) As ils(Of T)
            Host.useds = {Info.delegate(Of T8).invoker, Info.delegate(Of T7).invoker, Info.delegate(Of T6).invoker, Info.delegate(Of T5).invoker, Info.delegate(Of T4).invoker, Info.delegate(Of T3).invoker, Info.delegate(Of T2).invoker, Info.delegate(Of T1).invoker}
            Return Host
        End Function
#End Region
